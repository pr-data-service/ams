...
public class ProjectController {
	...
	public ResponseEntity<ApiResponseEntity> get(@RequestHeader("apartment-id") Long apartmentId) throws Exception {
		logger.info("AMS - ProjectController get");
		return ResponseEntity.status(HttpStatus.OK).body(projectService.getSessionListByApartmentId(apartmentId));		
	}
}
